...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='cae_base_cifar', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data_set', default='CIFAR', choices=['CIFAR', 'IMNET', 'IMNET100', 'image_folder'],
