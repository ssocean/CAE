...
# my_name=${tmp_my_name%.*}
# my_name = cae-test
OUTPUT_DIR='/opt/data/private/CAE/output/cae-cs-naive-0109'
...
CUDA_VISIBLE_DEVICES=0,1 python3 -m torch.distributed.launch --nproc_per_node=2 /opt/data/private/CAE/tools/run_pretraining_cs_naive.py \
  --data_path ${DATA_PATH} \
  --output_dir ${OUTPUT_DIR} \
  --model com_cae_cifar_naive --discrete_vae_weight_path ${TOKENIZER_PATH} \
